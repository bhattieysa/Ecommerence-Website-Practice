...
export const heroCircleVariants = cva(['absolute', 'rounded-full', 'border', 'border-white/5'], {
    variants: {
        position: {
...
export const heroArrowContainerVariants = cva(['absolute', 'top-1/2', '-translate-y-1/2', 'z-30'], {
    variants: {
        side: {
...
export const heroPaginationDotVariants = cva(['rounded-full', 'transition-all', 'duration-300', 'ease-in-out'], {
    variants: {
        active: {
